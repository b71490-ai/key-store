        ...
        <section className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <form ref={productFormRef} onSubmit={handleSubmit} className="rounded-3xl border border-slate-200 bg-white p-7 shadow-[0_18px_45px_-30px_rgba(0,0,0,0.35)] md:p-8">
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-2">
              ...
              <input name="price" value={form.price} onChange={handleChange} required type="number" min="1" className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none transition focus:border-[#1475d1]" placeholder="السعر" />
